...
const fetchTodosAction = createAction("FETCH_TODOS", (result, entities) => {
  return { result, entities };
});
const createTodoAction = createAction("CREATE_TODO", (result, entities) => {
  return { result, entities };
});
const finishTodoAction = createAction("FINISH_TODO", entityId => {
  return { entityId };
});
